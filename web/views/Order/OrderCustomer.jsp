                ...
                <div class="row g-5">
                    <div class="col-md-5 col-lg-4 order-md-last">
                        ...
                        <div class="p-2 d-flex justify-content-between align-items-center gap-2">
                            ...
                            <button type="submit" class="btn btn-dark" onclick="orderProduct()">Check out</button>
                        </div>
                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body" style="background-color: #f8f8f8;">
                                                Ngân Hàng MB(MB) <br />
                                                STK: 338007 <br />
                                                Nguyen Thanh Duc <br /><br /> <br />
                                                Nội dung chuyển khoản: "Nguyen Thanh Duc chuyen tien ao"
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">

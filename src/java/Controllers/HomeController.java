...
public class HomeController extends ReloadController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion.getAttribute("changePass") != null) {
            boolean changePass = (Boolean) sesion.getAttribute("changePass");
            if (!changePass) {
                request.setAttribute("msg", "Mật khẩu cũ sai! Vui lòng kiểm tra lai!");
                sesion.setAttribute("changePass", null);
            } else {
